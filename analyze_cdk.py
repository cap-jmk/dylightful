...
if __name__ == "__main__":
    ...
    dirs = ["1KE5_1KE7_like_long/", "6GUH_1KE7_like_long/", "1KE7_remodelled_long/"]
    names = ["1KE5_dynophore", "6GUH_dynophore", "1KE7_dynophore"]
    states = [3, 4, 11]
    resnames = ["LS1", "FB8", "LS3"]
    for i in range(0, len(dirs)):
        print("*************" + names[i] + "*************")
        save_dir = "/home/julian/Documents/Master/CDKs/" + dirs[i]
        name = names[i]
